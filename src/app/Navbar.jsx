       ...
       dark:bg-gray-800
         z-index-10000  rounded-lg
          ...
          ease-in-out duration-500 "
            ...
            <div class="flex-1 flex bg-white dark:bg-dark flex-col overflow-hidden mx-24 rounded-lg ">
                <div class="container ">
                    <div class="flex justify-between items-center py-4  mx-1">
                      <div className='flex '>
                        ...
                        <TogglerMode/>
                        <button class="text-gray-500 hover:text-gray-600 px-1" id="open-sidebar">
