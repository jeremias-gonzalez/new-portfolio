...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[260vh] py-40 dark:bg-dark bg-white overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
